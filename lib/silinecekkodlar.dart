...
import 'package:flutter_local_notifications_example/screen/homescreen/homescreen.dart';
import 'package:flutter_local_notifications_example/screen/newuser/newuser.dart';
import 'package:flutter_local_notifications_example/theme.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) => MaterialApp(
    ...
    home: _users['login'] == 1 ? AnaSayfa() : NewUser(),
    // Eklenen actions ile appBar'a buton ekleme
    // onPressed fonksiyonunda _startForegroundServiceWithBlueBackgroundNotification() fonksiyonunu çağırma
  );
